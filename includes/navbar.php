...
<nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
    ...
    <div id="searchBar" class="hidden border-t border-white/5 bg-dark-900/95 backdrop-blur-xl">
        <div class="max-w-3xl mx-auto px-4 py-4">
            <div class="relative">
                ...
                <input type="text" id="globalSearch" placeholder="Cari informasi beasiswa, lomba, seminar..." class="w-full pl-11 pr-4 py-3 rounded-xl bg-dark-800 border border-white/10 text-dark-100 placeholder-dark-500 text-sm focus:outline-none focus:border-primary-500/50 focus:ring-2 focus:ring-primary-500/20 transition-all">
    ...
    <div id="mobileMenu" class="hidden lg:hidden border-t border-white/5 bg-dark-900/95 backdrop-blur-xl">
        <div class="px-4 py-4 space-y-1">
            <a href="/" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-dark-100 bg-white/5">
                <i class="fas fa-fire text-primary-400"></i>Beranda
            </a>
            <a href="/#trending" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-dark-300 hover:text-dark-100 hover:bg-white/5 transition-all">
                <i class="fas fa-chart-line"></i>Trending
            </a>
            <a href="/#kategori" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-dark-300 hover:text-dark-100 hover:bg-white/5 transition-all">
                <i class="fas fa-th-large"></i>Kategori
            </a>
            <a href="/#tentang" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-dark-300 hover:text-dark-100 hover:bg-white/5 transition-all">
